//we put all the hard coded dat into the config file
//in some ccompany it is used to named as constant file as well

export const IMG_CDN_URL = "https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"

export const GET_RESTAURANT_MENU = "https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=21.1458004&lng=79.0881546&restaurantId="
//config driven ui
//data api from website
//data generally dynamic
export const ResaturentList = [
    {
      type: "restaurant",
      info: {
        id: "253596",

...
`package-lock.json`:
* Never put this in git ignore
* put this it in git [project  ]
...
A:
* node modulrs are like database for your npm
...
* even it is part of meme culture ,heavyest object in the universe
